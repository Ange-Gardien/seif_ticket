...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      <a class="nav-item nav-link active" href="categorie.php"><h4>Categories</h4> <span class="sr-only">(current)</span></a>
	...
	<div class="container">
		<div class="box">
			<h4 class="display-4 text-center">Liste Des produit</h4><br>
			...
			<div class="link-right">
				<a href="produit.php" class="link-primary">CreateP</a>
			</div>
		</div>
	</div>
</body>
